...
import { TbLogicAnd, TbLogicNot } from "react-icons/tb";

export class NotGateComponentSkin extends ComponentSkin {
  constructor(
    x: number,
    y: number,
    w: number,
    h: number,
    component: NotGateComponent
  ) {
  ...
  render(isPreview: boolean = false) {
    return (
      ...
      >
        <TbLogicNot size={48} color="#6a8a12" />
      </div>
    );
  }
}
