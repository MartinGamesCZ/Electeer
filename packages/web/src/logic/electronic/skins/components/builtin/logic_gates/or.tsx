...
import { TbLogicAnd, TbLogicNot, TbLogicOr, TbLogicXor } from "react-icons/tb";
...
import { OrGateComponent } from "@/logic/electronic/components/builtin/logic_gates/or";

export class OrGateComponentSkin extends ComponentSkin {
  constructor(
    x: number,
    y: number,
    w: number,
  ...
  render(isPreview: boolean = false) {
    return (
      ...
      >
        <TbLogicOr size={48} color="#6a8a12" />
      </div>
    );
  }
}
